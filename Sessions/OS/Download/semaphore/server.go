...
const (
	url            = "http://127.0.0.1:8081/largefile.bin"
	partCount      = 10 // total parts
	maxConcurrency = 4  // max concurrent downloads
...
func main() {
	...
	// Create a buffered channel acting as a semaphore with capacity maxConcurrency
